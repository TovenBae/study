...
class Blockchain:
    ...
    def new_block(self, nonce, prevhash):
        ...
        new_block = {
            ...
            'transaction': copy.deepcopy(self.current_transactions),
            # Change to markle tree's hash is better
            'timestamp': time(),
            'nonce': nonce
            # bits, hash required
        }
    ...
    def hash_block(block):
        ...
        :param block: Non-hashed block dictory
        :type block: dict
    ...
    def new_transaction(self, sender, recipient, amount):
        """
        Add new transaction on standby block
